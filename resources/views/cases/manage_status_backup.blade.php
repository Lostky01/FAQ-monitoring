    ...
    <section class="service-one my-5" id="services">
        ...
        <div class="col-md-12 col-lg-12">
                ...
                <form action="" method="get">
                    <!-- Coba Coba -->
                    <div class="row gutters-tiny jarak-kiri" style="font-family:Open Sans font-style:bold">
...
<!-- Batas -->
                    ...
                    <div class="col-md-12">
                    <button type="button" class="btn simpan-btn tambah my-3 pull-right pull-down" tipe="valid">Checked Valid</button>
                    <button type="button" class="btn simpan-btn btn-inval my-3 pull-right mr-2" tipe="non-valid">Checked Invalid</button>
                    </div>
                </div>

                <img src="{{asset('public/img/aset/Icon awesome-calendar-alt.png')}}" alt="" width="1.5%">
                ...
                <table id="example" class="table table-striped table-bordered data-case" style="width:100% text-align: 'center'">
                    ...
                    <!-- Perhitungan Jumlah Case Valid -->
                    <!-- </div>
                    <div>JUMLAH CASE VALID : <span id="result">{{ $jumlahValid }}</span></div>
                    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script> -->

                    <!-- Perhitungan Jumlah Case Invalid -->
                    <!-- <div id="boxes">
                        <div>JUMLAH CASE INVALID : <span id="result">{{ $jumlahNotValid }}</span></div>
                    </div>
                    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script> -->
                    
                    <!-- Perhitungan Jumlah Waiting Check -->
                    <!-- <div id="boxes">
                        <div>WAITING CHECK : <span id="result">{{ $dalamproses }}</span></div>
                    </div>
                    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script> -->
                    
                    <!-- Perhitungan Total Case -->
                    <!-- <div id="boxes">
                        <div>TOTAL : <span id="result">{{ $totalcase }}</span></div>
                    </div> -->
