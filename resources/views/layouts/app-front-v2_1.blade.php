...
@section('css')
    ...
    <head>
        ...
        <link rel="icon" type="image/png" sizes="192x192"
            href="{{ asset('public/img/favicon3/android-icon-192x192.png') }}">
    ...
    <body>
        ...
        <div class="page-wrapper">
            ...
            <header class="site-header header-one desktop-show" style="background-color: #fff;">
                <nav class="navbar navbar-expand-lg navbar-light header-navigation stricky slideIn animated width-offset-desk nav-box-sh"
                    style="background-color: #fff;">
                    <div class="row clearfix w-100 ">
                        <!-- Brand and toggle get grouped for better mobile display -->
                        <div
                            class="col-2 col-lg-2 col-xl-2 logo-box clearfix d-flex justify-content-center align-items-center bg-1D7B85">
                            <img src="{{ asset('public/img/aset/monitoring-globaldeva-goodeva-logo.png') }}"
                                style="width: 75%; height: auto;" class="main-logo" alt="Awesome Image">
                        </div><!-- /.logo-box -->
                    ...
                    <a class="ex3 header-menu-c" href="{{ url('home') }}">Materi</a>
                                ...
                                <li class="scrollToLink">
                                    <a class="ex3 header-menu-c" href="#blog">Leader Board<button
                                ...
                                <li class="scrollTolink">
                                    ...
                                    @if ($role == '2')
                                        <a class="ex3 header-menu-c" href="#blog">Report<button
                                                class="sub-nav-toggler"> <span class="sr-only">Toggle navigation</span>
                                    ...
                                    @if ($role == '3')
                                        <a class="ex3 header-menu-c" href="#blog">KPI<button class="sub-nav-toggler">
                                ...
                                <li class="scrollToLink">
                                    <a class="ex3 header-menu-c" href="#blog">Monitoring<button
                                            class="sub-nav-toggler"> <span class="sr-only">Toggle navigation</span> <span
                                                class="icon-bar"></span> <span class="icon-bar"></span> <span
                                                class="icon-bar"></span> </button></a>
                                    <ul class="sub-menu">
                                        @if ($role == '2')
                                            ...
                                            <li><a href="{{ url('reporting-monitoring-v2-dev') }}">Reporting Monitoring
                                                    V2</a></li>
                        ...
                        <div
                            class="col-2 col-lg-2 col-xl-2 d-flex justify-content-center align-items-center right-side-box warna-logout">
                            <form action="/logout" method="post">
                                @csrf
                                <button type="submit" class="logoutbtn text-white"><img
                                        style="width: 25px; height:20px; margin-right: 15px;"
                                        src="{{ asset('public/img/logo/logo-logout.png') }}" alt="Awesome Image">Log
                                    Out</button>
                            </form>
                        </div><!-- /.right-side-box -->
                    </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light header-navigation stricky slideIn animated"
                    ...
                    <div class="container-fluid clearfix">
                        ...
                        <div class="logo-box clearfix">
                            <img src="{{ asset('public/img/aset/monitoring-globaldeva-goodeva-logo.png') }}"
                                style="width: 48px; height: 70px; margin-left: 25%" class="main-logo"
                                alt="Awesome Image">
                    ...
                    <a class="ex3" href="{{ url('home') }}" style="color: #464A53;">Materi</a>
                                ...
                                <li class="scrollToLink">
                                    <a class="ex3" href="#blog" style="color: #464A53;">Leader Board<button
                                            class="sub-nav-toggler"> <span class="sr-only">Toggle navigation</span> <span
                                                class="icon-bar"></span> <span class="icon-bar"></span> <span
                                                class="icon-bar"></span> </button></a>
                                    <ul class="sub-menu">
                                ...
                                <li class="scrollTolink">
                                    ...
                                    @if ($role == '2')
                                        <a class="ex3" href="#blog" style="color: white;">Report<button
                                                class="sub-nav-toggler"> <span class="sr-only">Toggle navigation</span>
                                                <span class="icon-bar"></span><span class="icon-bar"></span><span
                                                    class="icon-bar"></span><span class="icon-bar"></span> <span
                                                    class="icon-bar"></span></button></a>
                                    ...
                                    @if ($role == '3')
                                        <a class="ex3" href="#blog" style="color: white;">KPI<button
                                                class="sub-nav-toggler"> <span class="sr-only">Toggle navigation</span>
                                                <span class="icon-bar"></span><span class="icon-bar"></span> <span
                                                    class="icon-bar"></span></button></a>
