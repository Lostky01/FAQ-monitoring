      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
            <label for="project" class="form-label">Nama Client</label><br>
            <select class="js-example-basic-single" id="select-client" name="id_client" required>
          ...
          <div class="col-md-12 mb-3">
            ...
            <select class="js-example-basic-single" id="select-project" name="id_site" required>
              <option value="" selected disabled>pilih client terlebih dahulu</option>
        ...
        <div class="row" id="list_image">
          <div class="col-md-6 mb-3 image1">
            ...
            <input type="file" class="dropify" name="image_1" data-max-file-size="1M" data-allowed-file-extensions="jpg jpeg png gif" image_list="1">
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
...
<script>
  ...
  //   $.ajax({
  //     method: 'get',
  //     url: "{{ url('FAQ/getName') }}/" + id, // Pass the id parameter
  //     success: function(result) {
  //       if (result.msg == 'berhasil') {
